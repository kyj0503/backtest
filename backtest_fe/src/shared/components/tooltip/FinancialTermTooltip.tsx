...
const financialTerms: Record<string, string> = {
  ...
  // 투자 방식
  '일시불 투자': '백테스트 첫 날에 전체 금액을 한 번에 투자하는 방식입니다. 시장 타이밍이 중요합니다.',
  '분할 매수 (DCA)': '지정한 주기마다 같은 금액으로 나누어서 투자하는 방식입니다. 평균 단가를 낮추는 효과가 있습니다.',
  'DCA': 'Dollar Cost Averaging의 줄임말. 분할 매수와 같은 의미입니다. 시장 변동성에 따른 리스크를 줄일 수 있습니다.',
  '투자 방식': '자산을 구매하는 방법. 일시불(한 번에) 또는 분할 매수(정기적으로 나누어) 중 선택 가능합니다.',

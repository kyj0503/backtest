    ...
    <div className="min-h-screen bg-background py-8">
      <div className="mx-auto px-4 sm:px-6 lg:px-8 w-full max-w-screen-2xl">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="text-4xl font-extrabold text-primary mb-5 tracking-tight">
            백테스트
          </h2>
        ...
        {loading && (
          <Card className="border-primary/30 bg-primary/5 backdrop-blur-sm">
            <CardContent className="text-center py-20">
              ...
              <CardTitle className="text-2xl font-bold mb-3">백테스트 실행 중...</CardTitle>
              <CardDescription className="text-base">
        ...
        {!results && !loading && !error && (
          <Card className="border-dashed border-2 border-muted-foreground/30 bg-muted/20 backdrop-blur-sm">
            <CardContent className="text-center py-20">
              <div className="w-20 h-20 mx-auto mb-8 flex items-center justify-center bg-primary/15 rounded-2xl shadow-sm">

...
def test_golden_master_backtest_dca(mock_stock_repo, mock_currency_converter):
    ...
    with patch("app.api.v1.endpoints.backtest.portfolio_service.stock_repository", mock_stock_repo), \
         patch("app.services.portfolio_service.currency_converter", mock_currency_converter), \

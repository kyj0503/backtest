...
1.  **DCA/리밸런싱 첫 실행**: `PortfolioManagerService`(`app/services/portfolio_manager_service.py`)는 `get_weekday_occurrence`를 호출하여 시작 날짜의 "N번째" 값을 계산하고, 이를 `dca_info` 또는 `original_rebalance_nth` 변수에 저장합니다.
